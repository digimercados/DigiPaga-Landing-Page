...
export default function EmailSignup() {
  return (
    ...
    >
      ...
      <Button className=" md:absolute right-0 bg-[#296253] group hover:bg-[#19433a] text-[#F8F9F4] rounded-full px-6 py-2 w-full sm:w-auto" aria-label="Register for updates">
        Register
      </Button>
    </motion.div>
  )
