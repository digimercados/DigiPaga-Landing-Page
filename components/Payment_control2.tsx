...
export default function PaymentControlSection2() {
  ...
  return (
    <Container>
      <motion.section
      className="relative w-full py-12 md:py-16 lg:py-24 md:px-8 lg:px-16 gap-6  md:gap-12 flex flex-col items-center text-center overflow-hidden"
      initial="hidden"
      whileInView="visible"
    ...
    >
      ...
      {/* Main Content Grid */}
      <div className="container   justify-center w-full grid lg:grid-cols-2  gap-y-12 md:gap-6 items-center ">
        {/* Left Image Column */}
        
       <div className="flex flex-col  px-2 py-6 bg-[#F8F9F4] rounded-lg md:px-8 md:py-8 space-y-5 text-center lg:text-left">
          <motion.div
            className="inline-flex text-xs items-center justify-center  border border-[#DFE2D4] lg:justify-start bg-[#EDF0E3] text-[#296253] md:text-sm font-medium px-4 py-2 rounded-full self-center lg:self-start will-change-transform"
            variants={itemVariants}
          >
        DigiPaga Invoice Managment         
          </motion.div>

          <motion.h3 className="text-2xl w-full md:text-4xl lg:text-4xl tracking-tight text-gray-900 leading-tight will-change-transform" variants={itemVariants}>
            Manage you Invoices in <span className="text-[#B7DF30]">15 different currencies</span>
          </motion.h3>

          <motion.p className="max-w-xl mx-auto lg:mx-0 text-xs md:text-xl text-gray-600 will-change-transform" variants={itemVariants}>
      ...
      />
        ...
        {/* Right Content Column */}
         ...
         <motion.div
          className="relative flex justify-center lg:justify-start items-center  will-change-transform"
