...
export default function CashAccessSection() {
  ...
  return (
    <Container>
      <section className="relative w-full rounded-tr-[50px] rounded-tl-[50px] bg-[#296253] py-12 md:py-24 lg:py-24 px-4 md:px-8 lg:px-16 flex flex-col items-center overflow-hidden" aria-labelledby="cash-access-heading">
      <motion.div
